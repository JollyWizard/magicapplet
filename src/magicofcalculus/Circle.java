...
public class Circle extends Component {
    ...
    public DPoint getCenter() {return _center;}
    ...
    //From Component
    public void setPosition(DPoint p) {setCenter(p);}
    public DPoint getPosition() {return new DPoint(_center);}
...
//    private final static int HIT_MARGIN=5;
	...
	_ellipse.setFrame(_center.x-_diameter/2,_center.y-_diameter/2,_diameter,_diameter);
    }
}
//------------------------------------------------
