...
public class SceneSummary {
  ...
  public List<Class<? extends Scene.Action>> actions_scene =
          new LinkedList<Class<? extends Scene.Action>>();
  ...
  public String toString () {
    return index + " | " + name + "( show: " + added.size()
            + " | hide: " + removed.size() + " ) ";
  }
  ...
  private ActionRow buildActionRow (
          List<Class<? extends Action>> actions, int i) {
