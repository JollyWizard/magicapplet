...
public abstract class XML {
  ...
  public XML() {
    ...
    initXMLAttributes();
    HashMap<Field, Attribute> hm =
            Collect.fieldMap(this, XML.Attribute.class);
   ...
   */
  public abstract void initXMLAttributes ();
   ...
   *  "&lt;name attribute1="x" attribute2=3 ... /&gt;"
   * else 
   *  "&lt;name attribute1="x" attribute2=3 ... &gt;"</pre>
   */
  public String open (Boolean close) {
    ...
    Set<Attribute> attrs =
            Collect.fieldValues(this, XML.Attribute.class);
    for (Attribute a : attrs) {
      r.append(a.toDeclaration());
      r.append(" ");
    }
    //single line tag if close is true
    if (close != null && close) r.append("/");
    r.append(">");
    return r.toString();
  }
